...
<body class="bg-gray-100">
  <div class="container mx-auto px-4 py-8 max-w-7xl">
    ...
    <div class="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-8 rounded-lg shadow-lg mb-8">
      ...
      <p class="text-xl opacity-90">5次元分析 × AIで株価を予測</p>
    ...
    <div id="analysis-tab" class="tab-content active">
      ...
      <div id="analysis-loading" style="display:none;">
        ...
        <p class="text-center text-gray-600">分析中... AIで詳細分析を実行しています</p>
      </div>
  ...
  <script>
      ...
      try {
        ...
        content = \`
          <div class="bg-gradient-to-r from-yellow-500 to-yellow-600 text-white p-6">
            ...
            <p class="mt-2 text-yellow-100">最新ニュースをAIで分析</p>
          </div>
          <div class="p-6">
            <div class="grid grid-cols-2 gap-6 mb-6">
            ...
            <div class="bg-yellow-50 p-4 rounded-lg mb-6">
              <h3 class="font-bold text-lg mb-3"><i class="fas fa-robot mr-2"></i>AI分析</h3>
    ...
    async function analyzeStock() {
      ...
      let loadingMessage = '分析中... AIで詳細分析を実行しています'
        ...
        const resultHTML = \`
          <div class="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            <div class="bg-gray-50 p-6 rounded-lg">
              <h4 class="font-bold mb-3"><i class="fas fa-robot mr-2"></i>AIによる詳細解説</h4>
